# Extra Trees Regression in Scikit-Learn with Shapley Explanations

## Project Description

This repository is a dockerized implementation of the Extra Trees regressor. It is implemented in flexible way that it can be used with any regression dataset with the use of JSON-formatted data schema file.
...
- A **Extra Trees Regression** algorithm built using **SciKit-Learn**
...
- **`src/`**: This directory holds the source code for the project. It is further divided into various subdirectories:
  ...
  - **`prediction/`**: Scripts for the Extra Trees Regression classifier model implemented using **Scikit-Learn** library.
